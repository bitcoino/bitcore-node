...
var BASE_PACKAGE = {
  ...
  repository: 'https://github.com/usdfork/bitcore-node-zecmate',
  license: 'MIT',
  readme: 'README.md',
  dependencies: {
    'bitcore-lib-zelcash': 'usdfork/bitcore-lib-zelcash',
    'bitcore-node-zecmate': 'usdfork/bitcore-node-zecmate'
  }
};
